...
# Startup 2 nodes
$GOPATH/bin/rqlite -s 50 node_1 &
sleep 2s

# Do a massive insert insert, this is an example from my db
...
'
curl -L -XPOST localhost:4001/db?pretty -d 'INSERT INTO "category" VALUES(9,"Bird Gyms & Playstands",4,"true","2015-04-14 00:27:31");
